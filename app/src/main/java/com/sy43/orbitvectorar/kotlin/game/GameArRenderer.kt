...
import com.sy43.orbitvectorar.java.common.samplerender.GLError
...
class GameArRenderer(val activity: GameArActivity) :
    ...
    override fun onSurfaceCreated(render: SampleRender) {
        ...
        try {
            ...
            planeRenderer = com.sy43.orbitvectorar.java.common.samplerender.arcore.PlaneRenderer(render)
