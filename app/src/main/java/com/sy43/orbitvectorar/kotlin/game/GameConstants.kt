...
object GameConstants {
    ...
    const val ARROW_MODEL_LENGTH = 0.35f
    ...
    // --- FORGIVING COLLISION RADII ---
    const val PLANET_FORGIVING_COLLISION_RADIUS = PLANET_MODEL_DEFAULT_RADIUS * 0.83f
    const val MOON_FORGIVING_COLLISION_RADIUS = PLANET_MODEL_DEFAULT_RADIUS * 0.83f
    const val APPLE_FORGIVING_COLLISION_RADIUS = APPLE_MODEL_DEFAULT_RADIUS * 1.1f
