...
data class Moon(
    ...
    fun getWorldPosition(): FloatArray {
        val x = orbitCenter[0] + orbitRadius * cos(currentAngle + orbitPhase)
        val y = orbitCenter[1]
        val z = orbitCenter[2] + orbitRadius * sin(currentAngle + orbitPhase)
...
data class GameState(
    var level: Int = 1,
    var points: Int = 0,
    var arrowsLeft: Int = GameConstants.INITIAL_ARROWS_PER_LEVEL,
