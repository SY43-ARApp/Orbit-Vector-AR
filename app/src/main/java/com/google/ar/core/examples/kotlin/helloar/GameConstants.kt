...
object GameConstants {
    ...
    const val PLANET_FORGIVING_COLLISION_RADIUS = PLANET_MODEL_DEFAULT_RADIUS * 0.73f
    const val MOON_FORGIVING_COLLISION_RADIUS = PLANET_MODEL_DEFAULT_RADIUS * 0.73f
